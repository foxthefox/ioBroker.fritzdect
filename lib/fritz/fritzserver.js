...
const content = fs.readFileSync('./data/test_api_response.xml');
//var content = fs.readFileSync('./test.xml');

const templates = fs.readFileSync('./data/template_answer.xml');

const temp_stats = fs.readFileSync('./data/devicestat_temp_answer.xml');

const power_stats = fs.readFileSync('./data/devicestat_power_answer.xml');

const color_defaults = fs.readFileSync('./data/color_defaults.xml');

const hkr_batt = fs.readFileSync('./data/hkr_response.xml');

const guestWlan = fs.readFileSync('./data/guest_wlan_form.xml');
