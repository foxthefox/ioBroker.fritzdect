...
Fritz.prototype = {
	call: function(func) {
		...
		return promise.then(
			function(sid) {
				...
				return func.apply(null, [ this.sid ].concat(args)).catch(
					function(error) {
						if (error.response && error.response.statusCode == 403) {
							...
							if (this.sid === null || this.sid === originalSID) {
								...
								return module.exports.getSessionID(this.username, this.password, this.options).then(
									function(sid) {
	...
	setHkrBoost: function(ain, time) {
		return this.call(module.exports.setHkrBoost, ain, time);
	},

	setWindowOpen: function(ain, time) {
		return this.call(module.exports.setWindowOpen, ain, time);
	},

	setBlind: function(ain, target) {
		return this.call(module.exports.setBlind, ain, target);
	},
	...
	setLevelPercentage: function(ain, level) {
		return this.call(module.exports.setLevelPercentage, ain, level);
	},
	...
	setColor: function(ain, saturation, hue) {
		return this.call(module.exports.setColor, ain, saturation, hue);
	},
...
module.exports.setHkrBoost = function(sid, ain, time, options) {
	return executeCommand(sid, 'sethkrboost&endtimestamp=' + time, ain, options).then(function(body) {
...
module.exports.setWindowOpen = function(sid, ain, time, options) {
	return executeCommand(sid, 'sethkrwindowopen&endtimestamp=' + time, ain, options).then(function(body) {
		// api returns the accepted endtimestamp
		return body;
	});
};
...
// set blind (blind etc.)
module.exports.setBlind = function(sid, ain, target, options) {
	return executeCommand(sid, 'setblind&target=' + target, ain, options).then(function(body) {
		// api does not return a value
		return target;
	});
};
...
module.exports.setColorTemperature = function(sid, ain, temp, options) {
	return executeCommand(sid, 'setcolortemperature&temperature=' + temp + '&duration=0', ain, options).then(function(
		body
	) {
		// api does not return a value
		return temp;
...
module.exports.setColor = function(sid, ain, saturation, hue, options) {
