...
class Fritz {
	...
	static async executeCommand(username, password, url, command, ain, options, path) {
		// console.log('exeCMD ', url, options, username, password, command);
...
const _Fritz = Fritz;
export { _Fritz as Fritz };

//--------------- sample code ----------------

var fritz = new Fritz('admin', 'FB-7673', 'http://192.168.178.1');
//var fritz = new Fritz('admin', 'password', 'http://192.168.178.41:3333');
//var fritz = new Fritz('iobroker', 'iobroker0815', 'http://192.168.178.1');
