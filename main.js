...
var Fritz = require('lib/fritzhttp').Fritz,
        ...
        fritz.getTemplateListInfos().then(function(templatelistinfos) {
            ...
            if (templates.length){
                ...
                templates.forEach(function (template){
                    if ((template.functionbitmask & 320) == 320 || (template.functionbitmask & 4160) == 4160 || (template.functionbitmask & 2688) == 2688 || (template.functionbitmask & 2944) == 2944){ //heating template
                        typ = "template_";
                        role = "switch";
