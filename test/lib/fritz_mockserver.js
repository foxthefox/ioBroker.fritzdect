...
const content = fs.readFileSync('./test/lib/data/test_api_response.xml');
//var content = fs.readFileSync('./test.xml');

const templates = fs.readFileSync('./test/lib/data/template_answer.xml');

const temp_stats = fs.readFileSync('./test/lib/data/devicestat_temp_answer.xml');

const power_stats = fs.readFileSync('./test/lib/data/devicestat_power_answer.xml');

const color_defaults = fs.readFileSync('./test/lib/data/color_defaults.xml');

const hkr_batt = fs.readFileSync('./test/lib/data//hkr_response.xml');

const guestWlan = fs.readFileSync('./test/lib/data/guest_wlan_form.xml');
