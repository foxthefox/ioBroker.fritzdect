...
*/
	...
	*/
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Comet', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_117951022222.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
							...
							states.getState('fritzdect.0.DECT_117951022222.devicelock', function(err, state) {
								...
								states.getState('fritzdect.0.DECT_117951022222.present', function(err, state) {
									...
									states.getState('fritzdect.0.DECT_117951022222.lock', function(err, state) {
										...
										states.getState('fritzdect.0.DECT_117951022222.komfort', function(err, state) {
											if (err) console.error(err);
											expect(state).to.exist;
											if (!state) {
												console.error('state "fritzdect.0.DECT_117951022222.komfort" not set');
											} else {
												console.log(
													'fritzdect.0.DECT_117951022222.komfort        ... ' + state.val
												);
											}
											expect(state.val).to.exist;
											expect(state.val).to.be.equal(19);
											states.getState('fritzdect.0.DECT_117951022222.absenk', function(
												err,
												state
											) {
												if (err) console.error(err);
												...
												states.getState('fritzdect.0.DECT_117951022222.offset', function(
													...
													expect(state.val).to.exist;
													expect(state.val).to.be.equal(20);
													states.getState('fritzdect.0.DECT_117951022222.celsius', function(
														err,
														state
													) {
														if (err) console.error(err);
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Comet', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_117951033333.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
							...
							states.getState('fritzdect.0.DECT_117951033333.devicelock', function(err, state) {
								...
								states.getState('fritzdect.0.DECT_117951033333.present', function(err, state) {
									...
									states.getState('fritzdect.0.DECT_117951033333.lock', function(err, state) {
										...
										expect(state.val).to.exist;
										expect(state.val).to.be.equal(false);
										states.getState('fritzdect.0.DECT_117951033333.komfort', function(err, state) {
											if (err) console.error(err);
											expect(state).to.exist;
											if (!state) {
												console.error('state "fritzdect.0.DECT_117951033333.komfort" not set');
											} else {
												console.log(
													'fritzdect.0.DECT_117951033333.komfort        ... ' + state.val
												);
											}
											expect(state.val).to.exist;
											expect(state.val).to.be.equal(19);
											states.getState('fritzdect.0.DECT_117951033333.absenk', function(
												err,
												state
											) {
												if (err) console.error(err);
												...
												states.getState('fritzdect.0.DECT_117951033333.offset', function(
													...
													expect(state.val).to.exist;
													expect(state.val).to.be.equal(20);
													states.getState('fritzdect.0.DECT_117951033333.celsius', function(
														err,
														state
													) {
														if (err) console.error(err);
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Comet wo battcharge', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_119600642220.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
							...
							states.getState('fritzdect.0.DECT_119600642220.devicelock', function(err, state) {
								...
								states.getState('fritzdect.0.DECT_119600642220.present', function(err, state) {
									...
									states.getState('fritzdect.0.DECT_119600642220.lock', function(err, state) {
										...
										expect(state.val).to.exist;
										expect(state.val).to.be.equal(false);
										states.getState('fritzdect.0.DECT_119600642220.komfort', function(err, state) {
											if (err) console.error(err);
											expect(state).to.exist;
											if (!state) {
												console.error('state "fritzdect.0.DECT_119600642220.komfort" not set');
											} else {
												console.log(
													'fritzdect.0.DECT_119600642220.komfort        ... ' + state.val
												);
											}
											expect(state.val).to.exist;
											expect(state.val).to.be.equal(21);
											states.getState('fritzdect.0.DECT_119600642220.absenk', function(
												err,
												state
											) {
												if (err) console.error(err);
												...
												states.getState('fritzdect.0.DECT_119600642220.offset', function(
													...
													expect(state.val).to.exist;
													expect(state.val).to.be.equal(20);
													states.getState('fritzdect.0.DECT_119600642220.celsius', function(
														err,
														state
													) {
														if (err) console.error(err);
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Contact', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_112240205290-1.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Button', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_119340141058-2.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Powerline', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_34:31:C1:AB:68:53.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
					...
					states.getState('fritzdect.0.DECT_087611016969.id', function(err, state) {
						...
						states.getState('fritzdect.0.DECT_087611016969.fwversion', function(err, state) {
							...
							states.getState('fritzdect.0.DECT_087611016969.manufacturer', function(err, state) {
								...
								expect(state.val).to.exist;
								expect(state.val).to.be.equal('AVM');
								states.getState('fritzdect.0.DECT_087611016969.celsius', function(err, state) {
									if (err) console.error(err);
									expect(state).to.exist;
									if (!state) {
										console.error('state "fritzdect.0.DECT_087611016969.celsius" not set');
									} else {
										console.log('fritzdect.0.DECT_087611016969.celsius          ... ' + state.val);
										expect(state.val).to.exist;
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Lamp DECT500 white', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_123456789012-1.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
	...
	it('Test ' + adapterShortName + ' adapter: Check values of Lamp DECT500 color', function(done) {
		this.timeout(30000);
		setTimeout(function() {
			states.getState('fritzdect.0.DECT_130770000415-1.productname', function(err, state) {
				if (err) console.error(err);
				expect(state).to.exist;
				if (!state) {
					...
					states.getState('fritzdect.0.DECT_099950403922.id', function(err, state) {
						...
						states.getState('fritzdect.0.DECT_099950403922.fwversion', function(err, state) {
							...
							states.getState('fritzdect.0.DECT_099950403922.manufacturer', function(err, state) {
								...
								expect(state.val).to.exist;
								expect(state.val).to.be.equal('AVM');
								states.getState('fritzdect.0.DECT_099950403922.celsius', function(err, state) {
									if (err) console.error(err);
									expect(state).to.exist;
									if (!state) {
										console.error('state "fritzdect.0.DECT_099950403922.celsius" not set');
									} else {
										console.log('fritzdect.0.DECT_099950403922.celsius          ... ' + state.val);
									}
									expect(state.val).to.exist;
