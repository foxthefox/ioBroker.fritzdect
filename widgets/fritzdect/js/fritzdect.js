            ...
            .on('click touchstart', function () {
                ...
                $.metroDialog({
                    ...
                    onShow: function (_dialog) {
                        ...
                        html += `<input type="checkbox" name="${wid}_checkbox" id="${wid}_checkbox" data-oid="${
                            switch_id
                        }"/>`;
                        ...
                        html += `<table style="margin-top: 1px; margin-left: 12px; font-size:14px;display:inline-block;">${
                            power_id
                                ? `<tr><td>${
                                  ...
                                  }:</td><td><span class="metro-dialog-string" data-oid="${power_id}">${
                                      val_power_id
                                  }</span>W</td></tr>`
                                : ''
                        }${
                            energy_id
                                ? `<tr><td>${
                                  ...
                                  }:</td><td><span class="metro-dialog-string" data-oid="${energy_id}">${
                                      val_energy_id
                                  }</span>Wh</td></tr>`
                                : ''
                        }${
                            temp_id
                                ? `<tr><td>${
                                  ...
                                  }:</td><td><span class="metro-dialog-string" data-oid="${temp_id}">${
                                      val_temp_id
                                  }</span>°C</td></tr>`
                                : ''
                        }</table>`;
